	    ...
	    <section class="featured-articles section section-header-offset">
	        ...
	        <div class="featured-articles-container container d-grid">
	                                                    ...
	                                                    <div class="article-data">
	                                                        ...
	                                                        <c:forEach var="sottoscrizione" items="${user.getSottoscrizioniPost()}"> 
		                                                        ...
		                                                        <c:when test="${found==false}"> 
		                                                         	 <c:set var="titleURL">
		                                                        	 <c:url value="http://192.168.1.109:8086/CodeForBreakfast/addPost" >
		                                                       ...
		                                                       <!--  </a> -->
																...
																<c:otherwise> 
																	<c:set var="titleURL">
			                                                        	 <c:url value="http://192.168.1.109:8086/CodeForBreakfast/removePostFromArticle" >
			                                                       		 	<c:param name="postId" value="${post.getId()}"/>
			                                                       		 	<c:param name="articlesPage" value="${2}"/> 
			                                                         	 </c:url>
			                                                         </c:set> 
	            ...
	            <div class="bottomline-banner2">  
	                ...
	                <a href="articles3.jsp" style="width: 5.5rem"><h3>next</h3></a>
	            </div>
	        </div> 
	    </section>
