...
<head>
    ...
    <title>Code for Breakfast | Anjana Vakil - Ooops! OOP's not what i thought  </title>
    <!-- Favicon -->
   ...
   <section class="featured-articles section section-header-offset">
        ...
        <div class="featured-content d-grid">
            ...
            <!-- The Conference -->
          	<%
	                 ...
	                 Conference actualConference = service.cercaConference(1);
	...
	<script>
		function onYouTubeIframeAPIReady() {
			...
			videoId: 'TbP2B1ijWr8', // YouTube Video ID
