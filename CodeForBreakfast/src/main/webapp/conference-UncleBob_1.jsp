    ...
    <%@ page import="com.protom.codeforbreakfast.service.ServiceMsg"%>
	 ...
	 %>
	  ...
	  <%   
     	...
     	serviceMsg.setValues(true,"Uncle Bob - SOLID principles","Conference");
...
<head>
    ...
    <title>Code for Breakfast | Uncle Bob - SOLID principles </title>
    <!-- Favicon -->
        ...
        <nav class="navbar container">
            ...
            <div class="menu" id="menu">
                <ul class="list">
                    ...
                    <li class="list-item">
                        <a href="conferences1.jsp" class="list-link current">Conferences</a>
                    </li>
                    <li class="list-item">
        ...
        <div class="featured-content d-grid">
            ...
            <!-- The Conference -->
          	<%
	                 ...
	                 Conference actualConference = service.cercaConference(12);
                     ...
                     <div class="info-article-data-container">
                           ...
                           <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                            ...
                            Phasellus lorem est, malesuada vel sapien consequat, ullamcorper rutrum eros.</p>
							 ...
							 <div id="muteYouTubeVideoPlayer" class="video-style"></div>
