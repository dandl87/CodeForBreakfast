        ...
        <nav class="navbar container">
            ...
            <div class="menu" id="menu">
                <ul class="list">
                    ...
                    <li class="list-item">
                        <a href="#" class="list-link">Conferences</a>
                    </li>
                    <li class="list-item">
                        <a href="#" class="list-link">Articles</a>
                    </li>
                    <li class="list-item">
    ...
    <section class="featured-articles section section-header-offset">
        ...
        <div class="featured-articles-container container d-grid">
            ...
            <div class="featured-content d-grid">
                ...
                <!--     First Post
                <a href="./post_git_gitHub.html" class="article featured-article featured-article-1">
                    <img src="./assets/images/featured/gitGitHubArtImg.jpg" alt="" class="article-image">
                    <span class="article-category">Technology</span>

                    <div class="article-data-container">

                        <div class="article-data">
                            <span>March 12th 2023</span>
                            <span class="article-data-spacer"></span> 
                        </div>

                        <h3 class="title article-title">Versioning</h3>

                    </div>
                </a>

                     Second Post
                <a href="./post_oop_conference_Anjana_Vakil_Oredev_2018.html" class="article featured-article featured-article-2">
                    <img src="./assets/images/featured/anjanaVakilArtImg.jpg" alt="" class="article-image">
                    <span class="article-category-conference">Conference</span>

                    <div class="article-data-container">

                        <div class="article-data">
                            <span>23 March 2023</span>
                            <span>Date of conference:19-22 November 2018</span>
                            <span class="article-data-spacer"></span>
                            <span>38 Min 50 sec </span>
                        </div>

                        <h3 class="title article-title"> OOP Anjana Vakil Øredev Conference</h3>
                ...
                <a href="./post.html" class="article featured-article featured-article-3">
                    <img src="./assets/images/featured/eccezioneArtImg.jpg" alt="" class="article-image">
                    <span class="article-category">Technology</span>
                    ...
                    <div class="article-data-container">
                        ...
                        <h3 class="title article-title">Exceptions</h3>  
            ...
            <div class="sidebar d-grid">
                ...
                <h3 class="title featured-content-title">New Posts</h3>
