...
<head>
    ...
    <title>Code for Breakfast | Conferences Page 2</title>
    <!-- Favicon -->
    ...
    <section class="featured-articles section section-header-offset">
        ...
        <div class="featured-articles-container container d-grid">
            ...
            <div class="bottomline-banner2">  
                <a href="conferences.jsp" style="width: 5.5rem"><h3>back</h3></a> 
                <a href="conferences3.jsp" style="width: 6rem" ><h3>next</h3></a>
            </div>
         </div>
